...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.valueLabel.frame = (CGRect){(self.view.bounds.size.width-self.valueLabel.frame.size.width)/2,70, self.valueLabel.frame.size};
    
    self.imageView.frame = (CGRect){(self.view.bounds.size.width-100)/2,120, 100,100};
